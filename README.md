...
This repository contains the agglomerative clustering scripts used in the PhytoOracle pipeline to track plants over time for each season, sorted and containerized by branch.

## Inputs
The containers take in a csv with at least the columns of 'genotype', 'lat', 'lon'.
